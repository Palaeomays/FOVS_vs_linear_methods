function [WorkPrecF,WorkPrecL]=WorkSimV3_i(Mx,Mn,tmax,fovsx,fovsn)
    ...
    for i= 1:fn
        ...
        WorkPrecF(2,i)=i;
        WorkPrecF(3,i)=2*fx+fnumberx+2*i+ncounter; %eF (Eqn 7)
        WorkPrecF(4,i)=100*sqrt( tab+ (fovsdx/sqrt(fx))^2 + (1/ncounter) );%Eqn 5
